...
#
#  $ bin/test -s bika.seedlab -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src bika.seedlab.testing.BIKA_SEEDLAB_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/bika/seedlab/tests/robot/test_example.robot
#
